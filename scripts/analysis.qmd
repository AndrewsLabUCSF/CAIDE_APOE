...
library(openxlsx)
write.xlsx (x = as.data.frame(tble1), file = "/Users/anaboeriu/Downloads/t1.xlsx")

  gt::gtsave("/Users/anaboeriu/Downloads/tble1.")
```
...
results_m2 = all_res %>% select(race, outcome, df2) %>% 
  ...
  rowwise() %>% 
  mutate_at(vars(-race, -outcome, -term,-p.value,
                 -or,-or_lci,-or_hci), ~ round(.x, digits = 3))
