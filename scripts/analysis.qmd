...
mcaide_mod_fit <- function(data){
  # glm(dx ~ apoe_geno + SEX + aoo, data = data, family = 'binomial')
  glm(dx ~ apoe + z_mcaide, data = cc_dat, family = 'binomial')
}
...
ggsave("results/figures/figure1_new.png", plot = figure1.p, units = 'in', width = 4, height = 2)
ggsave("results/figures/figure1_new.tiff", plot = figure1.p, units = 'in', width = 4, height = 2)
...
ggsave("results/figures/figure2.tiff", plot = figure2, width = 6, height = 3.5, units = 'in')
```
...
ggsave("results/figures/figure3.tiff", plot = figure3, width = 6, height = 3.5, units = 'in')
